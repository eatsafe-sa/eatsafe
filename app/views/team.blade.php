	...
	<!-- Three columns of text below the carousel -->
      <div class="row">
        <div class="col-sm-4">
          ...
          <a class="btn btn-social-icon btn-lg btn-twitter" href="https://twitter.com/StudioQuixotic" target="_blank"><i class="fa fa-twitter"></i></a><br /><br />
        </div><!-- /.col-lg-4 -->
        <div class="col-sm-4">
          ...
          <a class="btn btn-social-icon btn-lg btn-linkedin" href="http://www.linkedin.com/in/mariom1231/" target="_blank"><i class="fa fa-linkedin"></i></a><br /><br />
        </div><!-- /.col-lg-4 -->
        <div class="col-sm-4">
          ...
          <a class="btn btn-social-icon btn-lg btn-linkedin" href="https://www.linkedin.com/in/christopherreyna" target="_blank"><i class="fa fa-linkedin"></i></a><br /><br />
        </div><!-- /.col-lg-4 -->
      </div><!-- /.row -->
</div>
