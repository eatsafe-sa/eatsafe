...
<div class="container">
		<div class="well col-sm-8">
			...
			{{ Form::model(new User(), array('action' => array('UsersController@store', 'method' => 'PUT', 'role' => 'form', 'class' => 'form'))) }}
			{{ $errors->first('email', '<h3>Must Have an E-mail.</h3>')}}
					...
					<input type="submit" class="btn btn-lg btn-success" name="submit" value="Save User">
				{{Form::close()}}
